...
model = 'tfjs_checkpoints/music_vae/trio_4bar_lokl_small_q1' // input is list of pitches and chords '
...
//    player.start(quantizedInSequence);
    ...
    playNoteListMIDI(quantizedInSequence.notes)
}

async function playOutputSequence(){
    //Tone.Transport.bpm.value = tempo_bpm
    //player.start(quantizedOutSequence);
    playNoteListMIDI(quantizedOutSequence.notes)    
}
